...
def read_arguments():
    ...
    #mycode set args_dict['alphabet_data_paths'] to merged text of labeled and unlabeled data for cross domain exp.
    ...
    for split in args_dict['splits']:
        if args_dict['dataset'] == 'ontonotes':
            ...
            if '_' in args_dict['domain']:
                ...
                if split == "train":
                    print("\nHELLO2\n")
                    args_dict['alphabet_data_paths'][split] = data_path + '_' + split + '_' + args_dict['domain'].split('_')[0] #"data/ud_pos_ner_dp_train_jtr_2" #"/mount/projekte/codeswitch/betul/DCST/data/merged/tr_imstboun-ud-train-merged.conllu"
                else:  
                    print("\nHELLO3\n") 
                ...
                if split == "train": 
                    print("\nHELLO4\n")
                    args_dict['alphabet_data_paths'][split] =  "data/ud_pos_ner_dp_train_jtr_2" #"/mount/projekte/codeswitch/betul/DCST/data/merged/tr_imstboun-ud-train-merged.conllu"
                else:
                    print("\nHELLO5\n")
                    args_dict['alphabet_data_paths'][split] = args_dict['data_paths'][split]
                    print(args_dict['alphabet_data_paths'][split])
...
def main():
    ...
    if not args.eval_mode:
        ...
        for epoch in range(start_epoch + 1, args.num_epochs + 1):
            ...
            train_iter = prepare_data.iterate_batch(
