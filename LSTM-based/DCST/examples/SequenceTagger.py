...
def read_arguments():
    ...
    args_.add_argument('--rnn_mode', choices=['RNN', 'LSTM', 'GRU'], help='architecture of rnn',
                       required=True)
    args_.add_argument('--task', default='distance_from_the_root', choices=['distance_from_the_root', 'number_of_children', 'relative_pos_based', 'language_model', 'count_punct', 'simplified_morp_feats', 'head_simplified_morp_feats'], help='sequence_tagger task') #mycode added is_nonprojective
...
#mycode
        ...
        args_dict['data_paths'] = write_extra_labels.add_count_punct(args_dict['model_path'], args_dict['parser_path'], args_dict['domain'], args_dict['domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])

    elif args_dict['task'] == 'simplified_morp_feats':
        args_dict['data_paths'] = write_extra_labels.simplified_morp_feats(args_dict['model_path'], args_dict['parser_path'], args_dict['domain'], args_dict['domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
