...
def read_arguments():
    ...
    args_.add_argument('--rnn_mode', choices=['RNN', 'LSTM', 'GRU'], help='architecture of rnn',
                       required=True)
    args_.add_argument('--task', default='distance_from_the_root', choices=['distance_from_the_root', 'number_of_children', 'relative_pos_based', 'language_model', 'head_simplified_morp_feats', 'head_lang_ids', 'lang_ids', 'count_punct', 'case_label', 'morp_label', 'deprel_label', 'dummy_task'], help='sequence_tagger task')
    ...
    if args_dict['task'] == 'number_of_children':
        ...
        args_dict['data_paths'] = write_extra_labels.add_relative_pos_based(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'head_simplified_morp_feats':
        args_dict['data_paths'] = write_extra_labels.add_head_simplified_morp_feats(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'head_lang_ids':
        args_dict['data_paths'] = write_extra_labels.add_head_lang_ids(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'lang_ids':
        args_dict['data_paths'] = write_extra_labels.add_lang_ids(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'count_punct':
        args_dict['data_paths'] = write_extra_labels.add_count_punct(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'case_label':
        args_dict['data_paths'] = write_extra_labels.add_case_label(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'morp_label':
        args_dict['data_paths'] = write_extra_labels.add_morp_label(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'deprel_label':
        args_dict['data_paths'] = write_extra_labels.add_deprel_label(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    elif args_dict['task'] == 'dummy_task':
        args_dict['data_paths'] = write_extra_labels.add_dummy_task(args_dict['model_path'], args_dict['parser_path'], args_dict['src_domain'], args_dict['tgt_domain'],
                                                                                 use_unlabeled_data=args_dict['use_unlabeled_data'],
                                                                                 use_labeled_data=args_dict['use_labeled_data'])
    ...
    for split in args_dict['splits']:
        if args_dict['dataset'] == 'ontonotes':
            ...
            if '_' in args_dict['tgt_domain']:
                ...
                #mycode
                if split == 'train':
                    alphabet_data_paths['additional_' + split] = "/mount/projekte/codeswitch/betul/DCST/data/merged/tr_imstboun-ud-train-merged.conllu"
