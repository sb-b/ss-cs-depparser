...
class Trainer:
    ...
    def __init__(self, model, config, optimizer, loss, eval_criterion, train_data_loader, valid_data_loader,
        ...
        #mycode sequence labeler embeds
        #self.seq_embeddings = []
...
#mycode
    def dcst_train(self):
        ...
        #self.seq_embeddings = seq_trainer.parser.embed
        #print(torch.cuda.memory_summary(device=None, abbreviated=False))
       
       # self.parser.seq_embed = seq_trainer.parser.embed #self.seq_embeddings #mycode
        #print(torch.cuda.memory_summary(device=None, abbreviated=False))
       # del seq_trainer #mycode

       # self.parser.wa_layer = LinearWeightedAvg(2) #mycode initialize with weighted gated mechanism

       # print(self.parser.wa_layer)
        #print(torch.cuda.memory_summary(device=None, abbreviated=False))
...
#mycode
    ...
    def process_batch(self, batch, epoch, training=False): 
        ...
        outputs, batch_annotation_counts = self.parser.evaluate_batch(sentences, epoch) #mycode i added epoch
