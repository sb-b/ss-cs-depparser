...
def evaluate(gold_ud, system_ud):
    ...
    return {
        ...
        "UAS": alignment_score(alignment, lambda w, ga: ga(w.parent), filter_fn=lambda w: w.is_content_deprel),
...
if __name__=="__main__":
    ...
    g=codecs.open(g_filename, encoding='utf-8', errors='ignore')


    eval_args = Namespace(
            **{"gold_file": g, "system_file": f, "verbose": True, "counts": False})
   
    evaluate_basic(eval_args)
