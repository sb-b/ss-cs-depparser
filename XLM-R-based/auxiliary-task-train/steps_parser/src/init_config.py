...
class ConfigParser:
    ...
    def init_model(self):
        ...
        assert model_type == "MultiParser"  # TODO: This is kinda weird/redundant
        ...
        model_outputs = self._init_outputs(model_args["outputs"], embeddings_dim) #mycode added +100

        #mycode i made it an empty list for morp tagging only
