...
def evaluate_best_trained_model(trainer, config, eval_mode="basic"):
    ...
    """
    #checkpoint_path = "/mount/projekte18/codeswitch/betul/steps_parser_2/trained_models/QFN_Fame-2.8_baseline_train_NL_Alpino_dev_qfn/baseline_only_deps_batchsize_16_es_50/1207_110931/model_best.pth"
