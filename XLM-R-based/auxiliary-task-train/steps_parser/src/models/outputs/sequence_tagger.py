...
class SequenceTagger(nn.Module):
    ...
    def forward(self, embeddings_batch, true_seq_lengths):
        ...
        #print("real",logits,"real")

        #logits = torch.nn.Embedding(batch_size,seq_len,len(output_vocab))
        #for i,emb in enumerate(embeddings_batch):
        #   logits[i] = torch.logit(emb)
           
        #print(embeddings_batch)
        #logits = torch.logit(embeddings_batch, eps=1e-10) #mycode, for raw xlm-r
        #print("fake",logits,"fake")
