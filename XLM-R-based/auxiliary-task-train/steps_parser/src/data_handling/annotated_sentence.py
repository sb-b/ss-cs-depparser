...
class AnnotatedSentence:
    ...
    def __init__(self, tokens, annotation_data, multiword_tokens=None):
        ...
        """
        self.tokens = tokens
        assert self.tokens[0] == "[root]"  # TODO: Once we fix the [root] token problem, get rid of this
        ...
        for annotation_id in self.annotation_data:
            ...
            if isinstance(curr_annotation_data, TagSequence):
                # TODO: Once we fix the [root] token problem, check here for add_root flag instead of asserting equal length
    ...
    def from_conll(conll_lines, annotation_layers, keep_traces=False):
        ...
        for line in conll_lines:
            ...
            token_id = elements[0]
            print(elements)
            token_form = elements[1] #mycode just experimental, correct it to 1 again.
    ...
    def from_tensors(tokens, label_tensors, label_vocabs, annotation_types, multiword_tokens=None):
        ...
        """
        assert tokens[0] == "[root]"  # TODO: Once we fix the [root] token problem, get rid of this
    ...
    def tokens_no_root(self):
        ...
        # TODO: Once we fix the [root] token problem, get rid of this whole method
    ...
    def to_conll(self, column_mapping, num_cols=10):
        ...
        # TODO: Once we fix the [root] token problem, we can simplify this
    ...
    def get_tensorized_annotations(sentences, label_vocabs):
        ...
        Returns:
            ...
            """
        # TODO: Once we fix the [root] token problem, the shapes specified above need not necessarily hold
    ...
    def get_annotation_counts(gold, predicted):
        ...
        """
        assert gold.tokens == predicted.tokens  # TODO: Added in last patch, remove if it does not cause problems
