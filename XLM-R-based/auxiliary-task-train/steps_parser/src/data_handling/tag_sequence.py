...
class TagSequence:
    ...
    """
    # TODO: Once we fix the [root] token problem, change this docstring accordingly!
    # TODO: We should fix the [root] problem by getting rid of "ROOT" entirely. It makes no sense to include it
    # TODO: except as an ugly workaround.
    ...
    def from_conll(conll_lines, annotation_column, ignore_root=False):
        ...
        """
        # TODO: Once we fix the [root] token problem, get rid of ignore_root parameter!
        ...
        for line in conll_lines:
            ...
            print(elements)
            print(elements[annotation_column])
    ...
    def from_tensor(tokens, label_tensor, label_vocab):
        ...
        """
        # TODO: Replace "tokens" parameter with "sent_length" parameter!
        tags = list()
